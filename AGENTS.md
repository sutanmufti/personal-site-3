...
This is Sutan Mufti's personal site
...
This site is a blogsite where Sutan can pour his mind and share with the world. The content sections are the following:
- posts: should be under `./content/posts` can be list viewed.
- about: about Sutan Mufti. list the achievements, role history, and skills. include short contacts.
- projects: project sheet: a list of project Sutan was a part of.
- contacts: a page on Sutan's social; how to contact Sutan via email, Linkedin, and github
